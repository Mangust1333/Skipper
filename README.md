...
Рассмотрим варианты и рекомендацию для MVP.

## Вариант A — Лексическая (блочная) область видимости с разрешённым shadowing
...
**Выбор:** трейсинговый сборщик — *mark-and-sweep* (подходит для MVP: прост в понимании и реализации). Алгоритм: пометка достижимых объектов, затем освобождение непомеченных.
